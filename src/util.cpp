...
const char * const BITCOIN_CONF_FILENAME = "moneda.conf";
const char * const BITCOIN_PID_FILENAME = "monedad.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Moneda";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Moneda";
#else
    // Unix
    return pathRet / ".moneda";
#endif
#endif
}
