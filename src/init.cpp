...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/runencoin-project/runencoin>";
    const std::string URL_WEBSITE = "<https://runencoin.org>";
