...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s runencoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  runencoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded runencoin transaction") + "\n" +
              "  runencoin-tx [options] -create [commands]   " + _("Create hex-encoded runencoin transaction") + "\n" +
              "\n";
