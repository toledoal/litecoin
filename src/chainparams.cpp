...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.runencoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.runencointools.com", true);
        vSeeds.emplace_back("dnsseed.runencoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.runencointools.com", true);
        vSeeds.emplace_back("seed-b.runencoin.loshan.co.uk", true);
