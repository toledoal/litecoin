...
* moneda.conf: contains configuration settings for monedad or moneda-qt
* monedad.pid: stores the process id of monedad while running
...
* debug.log: contains debug information and general logging generated by monedad or moneda-qt
