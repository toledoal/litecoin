Runencoin Core version 0.13.3 is now available from:

  <https://download.runencoin.org/runencoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/runencoin-project/runencoin/blob/0.13/src/chainparams.cpp#L214).
